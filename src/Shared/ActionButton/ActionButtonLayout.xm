...
static NSString *SCIActionButtonEnabledPrefKeyForSource(SCIActionButtonSource source) {
	switch (source) {
		case SCIActionButtonSourceFeed:
			return @"action_button_feed_enabled";
		case SCIActionButtonSourceReels:
			return @"action_button_reels_enabled";
		case SCIActionButtonSourceStories:
			return @"action_button_stories_enabled";
		case SCIActionButtonSourceDirect:
		default:
			return @"action_button_messages_enabled";
	}
}
...
void SCIInstallFeedActionButton(UIView *barView) {
	...
	if (![SCIUtils getBoolPref:SCIActionButtonEnabledPrefKeyForSource(SCIActionButtonSourceFeed)]) {
...
void SCIInstallReelsActionButton(UIView *verticalUFIView) {
	...
	if (![SCIUtils getBoolPref:SCIActionButtonEnabledPrefKeyForSource(SCIActionButtonSourceReels)]) {
		[button removeFromSuperview];
		return;
	}
...
void SCIInstallStoriesActionButton(UIView *overlayView) {
	...
	if (![SCIUtils getBoolPref:SCIActionButtonEnabledPrefKeyForSource(SCIActionButtonSourceStories)]) {
		[button removeFromSuperview];
		return;
	}
...
void SCIInstallDirectActionButton(UIViewController *controller) {
	...
	BOOL shouldShowActionButton = [SCIUtils getBoolPref:SCIActionButtonEnabledPrefKeyForSource(SCIActionButtonSourceDirect)];
