...
+ (NSArray<SCIActionDescriptor *> *)descriptors {
    ...
    dispatch_once(&onceToken, ^{
        descriptors = @[
            [SCIActionDescriptor descriptorWithIdentifier:kSCIActionDownloadLibrary title:@"Download" iconName:@"download"],
            ...
            [SCIActionDescriptor descriptorWithIdentifier:kSCIActionDownloadGallery title:@"Download to Gallery" iconName:@"photo_gallery"],
            [SCIActionDescriptor descriptorWithIdentifier:kSCIActionExpand title:@"Expand" iconName:@"expand"],
            [SCIActionDescriptor descriptorWithIdentifier:kSCIActionViewThumbnail title:@"View Thumbnail" iconName:@"photo"],
...
+ (NSArray<SCIActionDescriptor *> *)availableSectionIconDescriptors {
    return @[
        ...
        [SCIActionDescriptor descriptorWithIdentifier:@"photo_gallery" title:@"Gallery" iconName:@"photo_gallery"],
