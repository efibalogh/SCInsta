...
+ (NSArray<SCIActionDescriptor *> *)descriptors {
    ...
    dispatch_once(&onceToken, ^{
        descriptors = @[
            ...
            [SCIActionDescriptor descriptorWithIdentifier:kSCIActionDownloadVault title:@"Download to Vault" iconName:@"photo_gallery"],
...
+ (NSArray<SCIActionDescriptor *> *)availableSectionIconDescriptors {
    return @[
        ...
        [SCIActionDescriptor descriptorWithIdentifier:@"photo_gallery" title:@"Vault" iconName:@"photo_gallery"],
