...
@interface SCIGalleryLockViewController ()
...
@implementation SCIGalleryLockViewController
...
- (void)updateUIForMode {
    ...
    if (showBiometrics) {
        NSString *icon = [mgr biometryType] == SCIGalleryBiometryTypeFaceID ? @"faceid" : @"touchid";
