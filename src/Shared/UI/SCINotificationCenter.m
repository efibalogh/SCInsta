...
NSArray<NSDictionary *> *SCINotificationPreferenceSections(void) {
    return @[
        ...
        @{@"title": @"Profile", @"items": @[
            ...
            SCINotificationItem(kSCINotificationProfileViewPicture, @"View Profile Picture", @"photo"),
            SCINotificationItem(kSCINotificationProfileSharePicture, @"Share Profile Picture", @"share"),
            SCINotificationItem(kSCINotificationProfileGalleryPicture, @"Save Profile Picture to Gallery", @"media"),
            SCINotificationItem(kSCINotificationProfileOpenSettings, @"Open Profile Settings", @"settings"),
        ]},
        @{@"title": @"Media", @"items": @[
            SCINotificationItem(kSCINotificationMediaPreviewSavePhotos, @"Preview Save to Photos", @"download"),
            SCINotificationItem(kSCINotificationMediaPreviewSaveGallery, @"Preview Save to Gallery", @"media"),
            SCINotificationItem(kSCINotificationMediaPreviewShare, @"Preview Share", @"share"),
            SCINotificationItem(kSCINotificationMediaPreviewCopy, @"Preview Copy Media", @"copy"),
            SCINotificationItem(kSCINotificationMediaPreviewDeleteGallery, @"Delete Gallery Media", @"trash"),
            SCINotificationItem(kSCINotificationMediaPreviewOpenGallery, @"Open Gallery Media", @"media"),
        ...
        @{@"title": @"Gallery", @"items": @[
            ...
            SCINotificationItem(kSCINotificationGalleryDeleteFile, @"Delete Gallery File", @"media"),
            SCINotificationItem(kSCINotificationGalleryDeleteSelected, @"Delete Selected Files", @"circle_check"),
            SCINotificationItem(kSCINotificationGalleryBulkDelete, @"Bulk Delete Tool", @"trash"),
