...
+ (SCISetting *)rootSetting {
    return SCITopicNavigationSetting(@"Reels", @"reels_prism", 24.0, @[
        SCITopicSection(@"Action Button", @[
            ...
            [SCISetting menuCellWithTitle:@"Default Tap Action" subtitle:@"Tap runs this action. Long press opens the full menu" menu:SCIActionButtonDefaultActionMenu(kSCIReelsActionButtonDefaultActionKey)]
        ], nil),
