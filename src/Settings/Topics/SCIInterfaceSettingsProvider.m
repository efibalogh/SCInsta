...
+ (SCISetting *)rootSetting {
    return SCITopicNavigationSetting(@"Interface", @"interface", 24.0, @[
        ...
        SCITopicSection(@"Experimental", @[
            [SCISetting navigationCellWithTitle:@"Liquid Glass" subtitle:@"Unsafe per-hook overrides for Instagram's internal liquid glass gates" icon:[SCISymbol symbolWithName:@"exclamationmark.triangle.fill" color:[UIColor systemOrangeColor] size:24.0] navSections:@[
