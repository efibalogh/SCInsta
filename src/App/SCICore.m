...
static NSDictionary *SCIFeatureDefaults(void) {
    NSMutableDictionary *defaults = [@{
        ...
        @"like_confirm_feed_post_likes": @(NO),
        @"like_confirm_feed_double_tap_likes": @(NO),
        @"like_confirm_comment_likes": @(NO),
        @"like_confirm_direct_quick_like": @(NO),
        @"dm_message_double_tap_confirm": @(NO),
        @"dm_message_reaction_confirm": @(NO),
        ...
        @"indicate_unsent_messages": @(YES),
        @"unsent_message_toast": @(YES),
        ...
        @"hide_meta_ai_explore": @(NO),
        @"hide_meta_ai_comments": @(NO),
        @"hide_meta_ai_creation": @(NO),
        @"hide_meta_ai_global": @(NO),
        @"hide_suggested_users_feed": @(NO),
        @"hide_suggested_users_reels": @(NO),
        @"hide_suggested_users_direct": @(NO),
        @"hide_suggested_users_search": @(NO),
        @"hide_suggested_users_profile": @(NO),
        @"hide_suggested_users_activity": @(NO),
        @"hide_suggested_users_follow_lists": @(NO),
        @"hide_suggested_users_subscriptions": @(NO),
        @"hide_reels_like_count": @(NO),
        @"hide_reels_comment_count": @(NO),
        @"hide_reels_repost_count": @(NO),
        @"hide_reels_reshare_count": @(NO),
        @"hide_reels_save_count": @(NO),
