...
static NSDictionary<NSString *, SCIAssetDescriptor *> *SCIAssetOverrides(void) {
    ...
    dispatch_once(&onceToken, ^{
        overrides = @{
            ...
            @"folder": @{@"candidates": @[@"ig_icon_folder_prism_outline_24"]},
            @"folder_move": @{@"candidates": @[@"ig_icon_folder_arrow_right_prism_outline_24"]},
            ...
            @"interface": @{@"candidates": @[@"ig_icon_device_phone_prism_outline_24"]},
            ...
            @"lock": @{@"candidates": @[@"ig_icon_lock_prism_filled_24"]},
            @"media": @{@"candidates": @[@"ig_icon_collage_prism_outline_24", @"ig_icon_media_outline_24"]},
            @"media_filled": @{@"candidates": @[@"ig_icon_media_filled_24"]},
            ...
            @"reels": @{@"candidates": @[@"ig_icon_reels_prism_outline_24"]},
            ...
            @"unlock": @{@"candidates": @[@"ig_icon_unlock_prism_filled_24"]},
